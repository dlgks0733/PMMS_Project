									...
									<div
										...
										<div class="col-lg-4">
											<label id="label1">제목</label> <input type="hidden"
												id="sendNum" value="${sVo.sendNum}"> <input
												type="text" class="form-control" value="${sVo.sendSubject}"
												name="sendSubject" id="sendSubject" readonly="readonly">
										</div>
										<div class="col-lg-4">
											<label id="label1">보낸 사람</label> <input type="text"
												class="form-control" readonly="readonly"
												value="${sVo.sendName}"> <input type="hidden"
												id="sendReceiver" value="${sVo.sendReceiver}">
										</div>
										<div class="col-lg-4">
											<label id="label1">날짜</label> <input type="text"
												class="form-control" readonly="readonly"
												value="${sVo.sendWriteDate}">
										</div>
										<div class="col-lg-4">
										...
										function(evt) {
											...
											if (confirmStat == true) {
												var messageNum = $('#sendNum')
														.val();
												alert("삭제되었습니다.");
												self.location = "prog?command=deleteMessage&sendNum="
														+ sendNum;
											} else {
												return false;
											}
