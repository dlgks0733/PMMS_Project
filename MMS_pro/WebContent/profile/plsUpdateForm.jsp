		...
		<div class="kt-portlet kt-portlet--mobile">
			<div class="kt-portlet__head kt-portlet__head--lg">
				<div class="kt-portlet__head-label">
					<h3 class="kt-portlet__head-title">프로그래밍 언어 숙련도 수정</h3>
				</div>
			</div>
			<div class="kt-portlet__body">
				<form class="kt-form" id="frm" >
							...
							<div class="kt-section kt-section--first">
								...
								<div class="kt-section__body">
									...
									<div class="form-group row">
										...
										<div class="col-9">
											<select class="form-control" id="profiency" name="profiency">
												<option value="${plsVo.profiency }" selected>${plsVo.profiency }</option>
									...
									<div class="form-group row">
										...
										<div class="col-9">
											<input class="form-control" type="text" name="experience" id="experience" value="${plsVo.experience }">
										</div>
									</div>
								...
								<div class="kt-form__actions kt-form__actions--right">
									<div class="row">
										...
										<div class="col kt-align-right">
											<button type="button" class="btn btn-brand" onclick="updatePls()">수정</button>
