		...
		<div class="kt-portlet kt-portlet--mobile">
			<div class="kt-portlet__head kt-portlet__head--lg">
				<div class="kt-portlet__head-label">
					<h3 class="kt-portlet__head-title">보유 자격증 수정</h3>
				</div>
			</div>
							...
							<div class="kt-section kt-section--first">
								...
								<div class="kt-section__body">
									...
									<div class="form-group row">
										...
										<input name="certNum" class="form-control" type="hidden" value="${myCertVo.certNum }">
										<div class="col-9">
											<input type="text" class="form-control" id="generalSearch" name="certName" readonly value="${myCertVo.certName }"> 
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-9">
											<input class="form-control" type="text" name="issueOrg" id="issueOrg" value="${myCertVo.issueOrg }" readonly disabled>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-9">
											<input type="text" class="form-control" id="kt_datepicker_1"
												readonly name="issueDate" value="${myCertVo.issueDate }">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-9">
											<input class="form-control" type="text" name="certSerial"
												id="certSerial"  value="${myCertVo.certSerial }">
										</div>
									</div>
