														...
														<div class="kt-section kt-section--first">
															...
															<div class="kt-section__body">
																...
																<div class="form-group row">
																	<label class="col-3 col-form-label">자격증 이름</label>
																	<div class="col-9">
												...
												<div class="kt-form__actions kt-form__actions--right">
													<div class="row">
														...
														<div class="col kt-align-right">
															<button type="button" class="btn btn-brand" onclick="registerCert()">등록</button>
														</div>
													</div>
												</div>
											</div>
...
function registerCert(){
	...
	$.ajax({
		...
		url: '/prog?command=certRegist',  // 이쪽으로 보낸다(호출URL)
		...
		success: function(data){  // 만약 성공적으로 수행되었다면 result로 값반환
			alert("등록 되었습니다.");
			self.close();
			opener.location.href = "/prog?command=certListForm";
		},
		error: function(data){
			alert("오류:: 다시 시도해주세요.");
			return false;
