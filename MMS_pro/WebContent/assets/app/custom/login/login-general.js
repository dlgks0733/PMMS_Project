...
var KTLoginGeneral = function() {
	...
	var showErrorMsg = function(form, type, msg) {
		var alert = $('<div class="kt-alert kt-alert--outline alert alert-'
				+ type
	...
	var displaySignUpForm = function() {
		...
		KTUtil.animateClass(login.find('.kt-login__signup')[0],
				'flipInX animated');
	}
	...
	var displaySignInForm = function() {
		...
		KTUtil.animateClass(login.find('.kt-login__signin')[0],
				'flipInX animated');
	...
	var displayForgotForm = function() {
		...
		KTUtil.animateClass(login.find('.kt-login__forgot')[0],
				'flipInX animated');
