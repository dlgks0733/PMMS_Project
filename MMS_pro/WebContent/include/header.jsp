...
<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="/main?command=main" class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
</svg></span><span class="kt-menu__link-text">메세지 관리</span></a></li> -->
<!-- <li class="kt-menu__section ">
...
<!-- PM Header -->
<c:if test="${LoginUser.grant eq '1'}">
<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
<ul class="kt-menu__nav ">
<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="/main?command=main" class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
...
<!-- Admin Header -->
<c:if test="${LoginUser.grant eq '2'}">
<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
<ul class="kt-menu__nav ">
<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="/main?command=main" class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
...
<!--begin: My Cart -->
<div class="kt-header__topbar-item dropdown">
<!-- <div class="kt-header__topbar-item kt-header__topbar-item--quick-panel" data-toggle="kt-tooltip" title="회원가입" data-placement="right">
...
<!-- <div class="kt-header__topbar-item kt-header__topbar-item--quick-panel" data-toggle="kt-tooltip" title="로그아웃" data-placement="right">
<span class="kt-header__topbar-icon" id="kt_quick_panel_toggler_btn"> 
<a href="main?command=logout">
...
<!--begin: Navigation -->
<a href="prog?command=profileForm&progNum=${LoginUser.progNum}" class="kt-notification__item">
...
<a href="prog?command=messageListForm" class="kt-notification__item">
<div class="kt-notification__item-icon">
